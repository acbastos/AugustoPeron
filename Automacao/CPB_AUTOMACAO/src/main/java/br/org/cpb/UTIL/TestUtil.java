...
public class TestUtil implements TestUtilInterface {
    ...
    */
	...
	public int gerarAno(){
		 ...
		 Random radom  = new Random();
	        int ano = 0;
	        ano=radom.nextInt(12);
	        return ano;
	}
	
	public static Date novaData(int dia, int mes, int ano, int hora, int minuto, int segundo) {
       Calendar calendar = Calendar.getInstance();
       calendar.set(dia, mes, ano, hora, minuto, segundo);
    ...
    * @return
    */
   public static String novaData(int ano, int mes, int dia) {
	   SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
	   String data = (dateFormat.format(novaData(ano, mes, dia, 0, 0, 0)));
